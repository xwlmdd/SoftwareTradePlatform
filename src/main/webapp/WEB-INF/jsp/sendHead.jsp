					...
					<nav class="navbar" role="navigation">
						...
						<div class="navbar-meun">
							<ul class="list-unstyled">
								<li><a href="<%=request.getContextPath()%>/stp/toPublicProject">发布项目</a></li>
						...
						<div class="navbar-meun">
							<ul class="list-unstyled">
								...
								<li><a href="<%=request.getContextPath()%>/stp/logout">退出</a></li>
							</ul>
						</div>
		...
		<div class="container main-user-container">
			<div class="row main-user-container-row">
				<div
					...
					<div class="role" style="width: 225px;height: 37px;padding-top: 10px">发包方个人中心</div>
					<ul class="list-unstyled onelevel">
						...
						<li><span>系统推荐承接方</span>
							<ul class="twolevel">
								<li><a href="<%=request.getContextPath()%>/stp/topAccept">系统推荐承接方</a>
								</li>
							</ul></li>
					</ul>
				</div>